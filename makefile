...
SRC_PATHS :=src;src/io;src/gfx;src/game;src/game/components;src/game/systems;src/gui;src/test;src/phys;src/structs;
VPATH = $(SRC_PATHS)
...
PHYS_SRC := $(wildcard src/game/*.cpp)
...
SRC := $(MAIN_SRC) $(IO_SRC) $(GFX_SRC) $(GAME_SRC) $(COMPONENTS_SRC) $(SYSTEMS_SRC) $(UI_SRC) $(TEST_SRC) $(PHYS_SRC) $(STRUCTS_SRC)
