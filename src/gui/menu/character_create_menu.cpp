...
#include "../gui.h"
#include "../../client/client_net_handler.h"
#include "../widget/choicebar.h"
#include "../../game/game_constants.h"
#include "../widget/text_entry_bar.h"
...
void CharacterCreateMenu::OnLoad(){
    ...
    TextEntryBar* name_entry = new TextEntryBar("name_entry",L"Enter name:");
/*
